...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(SpellweaverMod.modID + "Resources/images/powers/" + ID.replaceAll(SpellweaverMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(SpellweaverMod.modID + "Resources/images/powers/" + ID.replaceAll(SpellweaverMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
